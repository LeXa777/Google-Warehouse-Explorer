...
/**
 * Container for Webcam Viewer client state data.
 *
 * @author nsimpson
 */
@ExperimentalAPI
public class WebcamViewerCellClientState extends App2DCellClientState {

    private static final Logger logger = Logger.getLogger(WebcamViewerCellClientState.class.getName());
    private int preferredWidth;
    private int preferredHeight;
    private boolean decorated;           // show window decorations?
    private String checksum;

    public WebcamViewerCellClientState() {
        this(null);
    }

    public WebcamViewerCellClientState(Vector2f pixelScale) {
        super(pixelScale);
    }
    ...
    public String toString() {
        return super.toString() + " [WebcamViewerCellClientState]: " +
