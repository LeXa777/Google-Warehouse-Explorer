...
public class AnnotationComponentFactory implements CellComponentFactorySPI {

    public String getDisplayName() {
        return "Annotation Cell Component";
    }

    public <T extends CellComponentServerState> T getDefaultCellComponentServerState() {
        AnnotationComponentServerState state = new AnnotationComponentServerState();
        return (T)state;
    }

    public String getDescription() {
        return "Allow cell to display annotations";
    }
}
