 ...
 * this code.
 */
package org.jdesktop.wonderland.modules.imager.client;
...
import org.jdesktop.wonderland.modules.imager.client.jme.cellrenderer.ImagerCellRenderer;
...
@ExperimentalAPI
public class ImagerCell extends Cell {

    /* The image uri to use */
    private String imageURI = null;
    private ImagerCellRenderer  icr = null;
     ...
     */
    public ImagerCell (CellID cellID, CellCache cellCache) {
    ...
    public void setClientState(CellClientState clientState) {
        ...
        imageURI = ((ImagerCellClientState)clientState).getImageURI();
    }
    ...
    protected CellRenderer createCellRenderer(RendererType rendererType)
        ...
        if (rendererType == RendererType.RENDERER_JME) 
            {
            icr = new ImagerCellRenderer(this);
            return icr;
            }
        else
            {
