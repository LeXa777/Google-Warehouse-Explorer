...
public class CubicSplineSegment {
    ...
    // H.C 
    Vector3f  c0, c1, c2, c3; // coefficients for position
    Vector3f  e0, e1, e2, e3; // coefficients for scale
    ...
    private void computeHermiteCoefficients (TCBKeyFrame kf0,
        ...
        // Incoming Tangent
        Vector3f dd_pos    = new Vector3f();
        Vector3f dd_scale  = new Vector3f();
        ...
        // Outgoing Tangent
        Vector3f ds_pos   = new Vector3f();
        Vector3f ds_scale = new Vector3f();
    ...
    public void getInterpolatedQuaternion (float u, Quaternion newQuat) {
        ...
        if (this.linear == 1) {
            ...
            newQuat.slerp (keyFrame[1].quat, keyFrame[2].quat, u);
        }
    ...
    public void getInterpolatedScale (float u, Vector3f newScale) {
    ...
    public void getInterpolatedPosition (float u, Vector3f newPos) {
