 ...
 * @author Carl Jokl
 */
public class ToggleEditModeMenuListener implements ContextMenuActionListener {

    /**
     * The display text for this command.
     */
    public static final String DISPLAY_TEXT = "Toggle Edit Mode";
    ...
    public void actionPerformed(ContextMenuItemEvent event) {
        ...
        if (cell instanceof PathCell) {
            ...
            path.setEditMode(!path.isEditMode());
        }    
    }
}
