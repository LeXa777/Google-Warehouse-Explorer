 ...
 * @author Carl Jokl
 */
public class PoleNodeStyleBuilder implements NodeStyleBuilder {
    ...
    public NodeStyle createNodeStyle() {
        NodeStyle style = new NodeStyle(CoreNodeStyleType.POLE);
        style.addStyleAttribute(new FloatStyleAttribute(StandardStyleAttribute.RADIUS_1.getName(), new FloatValueRange(0.0f, 128.0f, false, true) , 0.0125f));
        style.addStyleAttribute(new FloatStyleAttribute(StandardStyleAttribute.RADIUS_2.getName(), new FloatValueRange(0.0f, 128.0f, false, true) , 0.0125f));
