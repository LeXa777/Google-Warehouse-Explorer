...
/**
 * A message sent to the TightVNCConnectionHandler to change the
 * settings of a particular TightVNC viewer.  The state of this message includes the
...
public class ChangeSettingsMessage extends Message {
    ...
    public ChangeSettingsMessage(int cellID, TightVNCRecord record) {
        super();
