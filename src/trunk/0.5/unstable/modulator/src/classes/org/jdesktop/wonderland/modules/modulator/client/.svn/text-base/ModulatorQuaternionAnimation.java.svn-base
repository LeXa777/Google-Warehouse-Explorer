 ...
 * @author morris
 */
public class ModulatorQuaternionAnimation extends AnimationProcessorComponent {
    /**
     ...
     * The constructor
     */
    public ModulatorQuaternionAnimation(Entity entity, Spatial target, Quaternion startQuat, Quaternion endQuat, Vector3f startTranslation, Vector3f endTranslation)
        {
        super(entity);
