 ...
 * @author morrisford
 */
public class ModulatorSingleNode 
    {
...
//            ModulatorQuaternionAnimation theQuatProc = new ModulatorQuaternionAnimation(renderer.getTheEntity(), theSpatial, keyFrames[0], keyFrames[5], keyTrans[0], keyTrans[5]);
...
/*
        ...
        for(int j = 0; j < Tkft.length - 1; j++)
            ...
            System.out.println("kft - " + Tkft[j]);
                ...
                ModulatorQuaternionAnimation theQuatProc = new ModulatorQuaternionAnimation(renderer.getTheEntity(), theSpatial, keyFrames[j], keyFrames[j + 1], keyTrans[j], keyTrans[j + 1]);
