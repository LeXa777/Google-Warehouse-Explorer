 ...
 * @author morrisford
 */
public class ModulatorMultipleNodes
    {
    private ModulatorRenderer renderer;
    ...
    public ModulatorMultipleNodes(ModulatorRenderer Renderer, String node1Name)
        {
        nodeCount = 1;
    ...
    public ModulatorMultipleNodes(ModulatorRenderer Renderer, String node1Name, String node2Name)
        {
        nodeCount = 2;
        this.node1Name = node1Name;
    ...
    public ModulatorMultipleNodes(ModulatorRenderer Renderer, String node1Name, String node2Name, String node3Name)
        {
        nodeCount = 3;
        this.node1Name = node1Name;
        this.node2Name = node2Name;
    ...
    public ModulatorMultipleNodes(ModulatorRenderer Renderer, String node1Name, String node2Name, String node3Name, String node4Name)
        {
        nodeCount = 4;
        this.node1Name = node1Name;
        this.node2Name = node2Name;
    ...
    public ModulatorMultipleNodes(ModulatorRenderer Renderer, String node1Name, String node2Name, String node3Name, String node4Name, String node5Name)
        {
        nodeCount = 5;
        this.node1Name = node1Name;
        this.node2Name = node2Name;
    ...
    public ModulatorMultipleNodes(ModulatorRenderer Renderer, String node1Name, String node2Name, String node3Name, String node4Name, String node5Name, String node6Name)
        {
        nodeCount = 6;
        this.node1Name = node1Name;
        this.node2Name = node2Name;
    ...
    public ModulatorMultipleNodes(ModulatorRenderer Renderer, String node1Name, String node2Name, String node3Name, String node4Name, String node5Name, String node6Name, String node7Name)
        {
        nodeCount = 7;
        this.node1Name = node1Name;
        this.node2Name = node2Name;
...
// Add each key frame info as an animation and then play the whole
            for(int j = startFrame; j < endFrame; j++)
                {
                t = new Timeline(this);
                t.addPropertyToInterpolate("Node4Quat", node4keyFrames[j], node4keyFrames[j + 1], new ModulatorQuaternionInterpolator());
                t.addPropertyToInterpolate("Node4Trans", node4keyTrans[j], node4keyTrans[j + 1], new ModulatorVectorInterpolator());
                t.setDuration((long)((Tkft[j + 1] - Tkft[j]) * 1000) * animationTimeMultiplier);
        ...
        if(nodeCount > 4)
            ...
            for(int j = startFrame; j < endFrame; j++)
                {
                t = new Timeline(this);
                t.addPropertyToInterpolate("Node5Quat", node5keyFrames[j], node5keyFrames[j + 1], new ModulatorQuaternionInterpolator());
                t.addPropertyToInterpolate("Node5Trans", node5keyTrans[j], node5keyTrans[j + 1], new ModulatorVectorInterpolator());
                t.setDuration((long)((Tkft[j + 1] - Tkft[j]) * 1000) * animationTimeMultiplier);
        ...
        if(nodeCount > 5)
            ...
            for(int j = startFrame; j < endFrame; j++)
                {
                t = new Timeline(this);
                t.addPropertyToInterpolate("Node6Quat", node6keyFrames[j], node6keyFrames[j + 1], new ModulatorQuaternionInterpolator());
                t.addPropertyToInterpolate("Node6Trans", node6keyTrans[j], node6keyTrans[j + 1], new ModulatorVectorInterpolator());
                t.setDuration((long)((Tkft[j + 1] - Tkft[j]) * 1000) * animationTimeMultiplier);
        ...
        if(nodeCount > 6)
            ...
            for(int j = startFrame; j < endFrame; j++)
                {
                t = new Timeline(this);
                t.addPropertyToInterpolate("Node7Quat", node7keyFrames[j], node7keyFrames[j + 1], new ModulatorQuaternionInterpolator());
                t.addPropertyToInterpolate("Node7Trans", node7keyTrans[j], node7keyTrans[j + 1], new ModulatorVectorInterpolator());
                t.setDuration((long)((Tkft[j + 1] - Tkft[j]) * 1000) * animationTimeMultiplier);
                node5result.addScenarioActor(t);
                }
            }
