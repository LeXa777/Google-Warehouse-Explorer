...
/**
 * Configuration element for the avatar torso.
 *
 * @author Jordan Slott <jslott@dev.java.net>
 */
@XmlRootElement(name = "avatar-torso")
public class MultimeshTorsoConfigElement extends MultimeshShapesConfigElement {
    /** Default constructor, for JAXB */
    public MultimeshTorsoConfigElement() {
    }
