 ...
 */
public class MultimeshEvolverAvatarLoader implements AvatarLoaderSPI {

    private static Logger logger = Logger.getLogger(MultimeshEvolverAvatarLoader.class.getName());
