 ...
 */
public class MultimeshEvolverAvatar implements AvatarSPI {

    private static Logger logger = Logger.getLogger(MultimeshEvolverAvatar.class.getName());
     ...
     */
    public MultimeshEvolverAvatar(ContentResource resource) {
     ...
     */
    public MultimeshEvolverAvatar(String avatarName, int version) {
    ...
    public void delete() {
        ...
        // server.
        MultimeshEvolverAvatarConfigManager.getEvolverAvatarConfigManager().deleteAvatar(this);
    }
    ...
    public AvatarConfigInfo getAvatarConfigInfo(ServerSessionManager session) {
        ...
        MultimeshEvolverAvatarConfigManager m = MultimeshEvolverAvatarConfigManager.getEvolverAvatarConfigManager();
        try {
