 ...
 */
@Plugin
public class MultimeshEvolverContentImporterPlugin extends BaseClientPlugin {

    private MultimeshEvolverContentImporter importer = null;

    @Override
    public void initialize(ServerSessionManager loginInfo) {
        importer = new MultimeshEvolverContentImporter(loginInfo);
