 ...
 */
@AvatarFactory
public class MultimeshEvolverAvatarFactory implements AvatarFactorySPI {

    private static Logger logger = Logger.getLogger(MultimeshEvolverAvatarFactory.class.getName());
