 ...
 */
public class hammerRotationAnimation extends AnimationProcessorComponent {
    /**
     ...
     * The constructor
     */
    public hammerRotationAnimation(Entity entity, Spatial target, float startDegrees, float endDegrees) {
        this(entity, target, startDegrees, endDegrees, new Vector3f(0f,1f,0f));
    }
    public hammerRotationAnimation(Entity entity, Spatial target, float startDegrees, float endDegrees, Vector3f axis) {
        super(entity);
