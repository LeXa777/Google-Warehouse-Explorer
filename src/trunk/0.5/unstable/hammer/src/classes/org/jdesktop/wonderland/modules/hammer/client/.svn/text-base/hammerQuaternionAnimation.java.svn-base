 ...
 * @author morris
 */
public class hammerQuaternionAnimation extends AnimationProcessorComponent {
    /**
     ...
     * The constructor
     */
    public hammerQuaternionAnimation(Entity entity, Spatial target, Quaternion startQuat, Quaternion endQuat, Vector3f startTranslation, Vector3f endTranslation)
        {
        super(entity);
