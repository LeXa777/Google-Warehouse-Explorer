...
public class hammerCell extends Cell
    {
//    private Set<Animation> animations = new HashSet<Animation>();
    ...
    private hammerSingleNode msn = null;
    private hammerThreeNodes m3n = null;
    private hammerMultipleNodes mmn = null;
    private hammerAllNodes man = null;
    
    public hammerCell(CellID cellID, CellCache cellCache)
        {
    ...
    public void setClientState(CellClientState state)
        ...
        this.modelURI = ((hammerCellClientState)state).getModelURI();
        }
    ...
    protected CellRenderer createCellRenderer(RendererType rendererType)
        ...
        if (rendererType == RendererType.RENDERER_JME)
            {
            this.renderer = new hammerRenderer(this);
    ...
    protected void setStatus(CellStatus status, boolean increasing)
        ...
        System.out.println("hammer - status = " + status + " - increasing = " + increasing);
...
// Build the final key frame Quats from the extracted angles and the Vectors from the extracted translates
    ...
    public void testAnimate(String theName)
        ...
        hammerRotationAnimation theRotProc = new hammerRotationAnimation(renderer.getTheEntity(), theSpatial, 0f, 360, new Vector3f(0f,1f,0f));
...
//        clip.start();
    ...
    ScriptingRunnable animateNodeRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(msn == null)
                {
                msn = new hammerSingleNode(renderer, avatar);
                }
    ...
    ScriptingRunnable animateOneNodeRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new hammerMultipleNodes(renderer, string1, string2);
                }
    ...
    ScriptingRunnable animate3NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new hammerMultipleNodes(renderer, string1, string2, string3);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate4NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new hammerMultipleNodes(renderer, string1, string2, string3, string4);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate5NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new hammerMultipleNodes(renderer, string1, string2, string3, string4, string5);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animateAllNodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(man == null)
                {
                man = new hammerAllNodes(renderer);
                }
