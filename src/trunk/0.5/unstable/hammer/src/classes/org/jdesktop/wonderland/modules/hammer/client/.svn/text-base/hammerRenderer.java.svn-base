 ...
 * @author morris
 */
public class hammerRenderer extends BasicRenderer
    {
    private Node root = null;
    private hammerCell motherCell = null;
    private Entity mye = null;

    public hammerRenderer(Cell cell)
        {
        super(cell);
        motherCell = (hammerCell)cell;
        }
