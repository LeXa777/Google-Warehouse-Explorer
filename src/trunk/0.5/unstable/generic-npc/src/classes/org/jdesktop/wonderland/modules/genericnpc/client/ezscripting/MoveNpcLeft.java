 ...
 */
@ScriptMethod
public class MoveNpcLeft implements ScriptMethodSPI {
    ...
    public String getDescription() {
        return "Move an npc to left one unit.\n" +
                "usage: MoveNpcLeft(cell);";
    }
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(MoveNpcLeft.class.getName()).log(Level.SEVERE, null, ex);
        }
