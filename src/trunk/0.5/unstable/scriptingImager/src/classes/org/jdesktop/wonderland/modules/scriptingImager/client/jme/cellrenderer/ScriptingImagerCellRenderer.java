 ...
 * $State$
 */
package org.jdesktop.wonderland.modules.scriptingImager.client.jme.cellrenderer;
...
import org.jdesktop.wonderland.modules.scriptingImager.client.ScriptingImagerCell;

/**
 * @author jkaplan
 */
public class ScriptingImagerCellRenderer extends BasicRenderer
    {
    ...
    public ScriptingImagerCellRenderer(Cell cell)
        {
        super(cell);
        }
    ...
    protected Node createSceneGraph(Entity entity)
        ...
        String  baseURI = cell.getCellCache().getSession().getSessionManager().getServerURL() + ((ScriptingImagerCell)cell).getImageURI() + "/" + cell.getName();
        try
            {
            ...
            {
            Logger.getLogger(ScriptingImagerCellRenderer.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        // Create a box of suitable dimensions
            box[i] = new Box("Box", new Vector3f(0, 3, 0), width[i], height[i], 0.1f);
