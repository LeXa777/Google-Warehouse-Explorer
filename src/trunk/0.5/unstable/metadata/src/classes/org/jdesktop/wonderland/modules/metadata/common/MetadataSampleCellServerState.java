 ...
 * @author jkaplan
 */
@XmlRootElement(name="metadata-sample-cell")
@ServerState
public class MetadataSampleCellServerState extends CellServerState {
    // @XmlElement(name="shape-type")
    // private String shapeType = null;

    /** Default constructor */
    public MetadataSampleCellServerState() {
    }

    @Override
    public String getServerClassName() {
        return "org.jdesktop.wonderland.modules.metadata.server.MetadataSampleCellMO";
    }
