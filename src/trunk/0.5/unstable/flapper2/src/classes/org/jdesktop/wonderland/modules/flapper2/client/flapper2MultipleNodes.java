 ...
 * @author morrisford
 */
public class flapper2MultipleNodes
    {
    ...
    public flapper2MultipleNodes(flapper2Renderer Renderer, String node1Name)
        {
        nodeCount = 1;
    ...
    public flapper2MultipleNodes(flapper2Renderer Renderer, String node1Name, String node2Name)
        {
        nodeCount = 2;
        this.node1Name = node1Name;
    ...
    public flapper2MultipleNodes(flapper2Renderer Renderer, String node1Name, String node2Name, String node3Name)
        {
        nodeCount = 3;
        this.node1Name = node1Name;
        this.node2Name = node2Name;
    ...
    public flapper2MultipleNodes(flapper2Renderer Renderer, String node1Name, String node2Name, String node3Name, String node4Name)
        {
        nodeCount = 4;
        this.node1Name = node1Name;
        this.node2Name = node2Name;
    ...
    public flapper2MultipleNodes(flapper2Renderer Renderer, String node1Name, String node2Name, String node3Name, String node4Name, String node5Name)
        {
        nodeCount = 5;
        this.node1Name = node1Name;
        this.node2Name = node2Name;
...
//                    (fromAngles[2] + rotFinalAngles[2] + animationStartRotation[2]));
            ...
            t.addPropertyToInterpolate("Node1Quat", quat, quatNext, new flapper2QuaternionInterpolator());

            ////            t.addPropertyToInterpolate("Node1Quat", node1keyFrames[j], node1keyFrames[j + 1], new flapper2QuaternionInterpolator());
...
//                        (node1keyTrans[j].z + animationStartTranslate.z));
                t.addPropertyToInterpolate("Node1Trans", tempVec, tempVecPlus, new flapper2VectorInterpolator());
                }
            else
                {
                Vector3f tempVec = new Vector3f(
...
////            t.addPropertyToInterpolate("Node1Trans", node1keyTrans[j], node1keyTrans[j + 1], new flapper2VectorInterpolator());
...
// Add each key frame info as an animation and then play the whole
            for(int j = startFrame; j < endFrame; j++)
                {
                t = new Timeline(this);
                t.addPropertyToInterpolate("Node2Quat", node2keyFrames[j], node2keyFrames[j + 1], new flapper2QuaternionInterpolator());
...
///            t.addPropertyToInterpolate("Node2Trans", tempVec, tempVecPlus, new flapper2VectorInterpolator());
///System.out.println("node2 - orig y = " + node2keyTrans[j].y + " - shift - " + tempVec.y);
                t.addPropertyToInterpolate("Node2Trans", node2keyTrans[j], node2keyTrans[j + 1], new flapper2VectorInterpolator());
//        t.setEase(new Spline(0.4f));
                t.setDuration((long)((Tkft[j + 1] - Tkft[j]) * 1000) * animationTimeMultiplier);
...
// Add each key frame info as an animation and then play the whole
            for(int j = startFrame; j < endFrame; j++)
                {
                t = new Timeline(this);
                t.addPropertyToInterpolate("Node3Quat", node3keyFrames[j], node3keyFrames[j + 1], new flapper2QuaternionInterpolator());
...
///            t.addPropertyToInterpolate("Node3Trans", tempVec, tempVecPlus, new flapper2VectorInterpolator());
///System.out.println("node3 - orig y = " + node3keyTrans[j].y + " - shift - " + tempVec.y);
                t.addPropertyToInterpolate("Node3Trans", node3keyTrans[j], node3keyTrans[j + 1], new flapper2VectorInterpolator());
//        t.setEase(new Spline(0.4f));
                t.setDuration((long)((Tkft[j + 1] - Tkft[j]) * 1000) * animationTimeMultiplier);
...
// Add each key frame info as an animation and then play the whole
            for(int j = startFrame; j < endFrame; j++)
                {
                t = new Timeline(this);
                t.addPropertyToInterpolate("Node4Quat", node4keyFrames[j], node4keyFrames[j + 1], new flapper2QuaternionInterpolator());
                t.addPropertyToInterpolate("Node4Trans", node4keyTrans[j], node4keyTrans[j + 1], new flapper2VectorInterpolator());
                t.setDuration((long)((Tkft[j + 1] - Tkft[j]) * 1000) * animationTimeMultiplier);
        ...
        if(nodeCount > 4)
            ...
            for(int j = startFrame; j < endFrame; j++)
                {
                t = new Timeline(this);
                t.addPropertyToInterpolate("Node5Quat", node5keyFrames[j], node5keyFrames[j + 1], new flapper2QuaternionInterpolator());
                t.addPropertyToInterpolate("Node5Trans", node5keyTrans[j], node5keyTrans[j + 1], new flapper2VectorInterpolator());
                t.setDuration((long)((Tkft[j + 1] - Tkft[j]) * 1000) * animationTimeMultiplier);
