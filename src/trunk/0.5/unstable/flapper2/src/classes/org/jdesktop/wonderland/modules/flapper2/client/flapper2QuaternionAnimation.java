 ...
 * @author morris
 */
public class flapper2QuaternionAnimation extends AnimationProcessorComponent {
    /**
     ...
     * The constructor
     */
    public flapper2QuaternionAnimation(Entity entity, Spatial target, Quaternion startQuat, Quaternion endQuat, Vector3f startTranslation, Vector3f endTranslation)
        {
        super(entity);
