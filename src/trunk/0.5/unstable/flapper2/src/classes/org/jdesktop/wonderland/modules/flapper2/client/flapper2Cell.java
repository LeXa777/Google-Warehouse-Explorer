...
public class flapper2Cell extends Cell
    {
//    private Set<Animation> animations = new HashSet<Animation>();
    ...
    private flapper2SingleNode msn = null;
    private flapper2ThreeNodes m3n = null;
    private flapper2MultipleNodes mmn = null;
    private flapper2AllNodes man = null;
    
    public flapper2Cell(CellID cellID, CellCache cellCache)
        {
    ...
    public void setClientState(CellClientState state)
        ...
        this.modelURI = ((flapper2CellClientState)state).getModelURI();
        }
    ...
    protected CellRenderer createCellRenderer(RendererType rendererType)
        ...
        if (rendererType == RendererType.RENDERER_JME)
            {
            this.renderer = new flapper2Renderer(this);
    ...
    protected void setStatus(CellStatus status, boolean increasing)
        ...
        System.out.println("flapper2 - status = " + status + " - increasing = " + increasing);
...
// Build the final key frame Quats from the extracted angles and the Vectors from the extracted translates
    ...
    public void testAnimate(String theName)
        ...
        flapper2RotationAnimation theRotProc = new flapper2RotationAnimation(renderer.getTheEntity(), theSpatial, 0f, 360, new Vector3f(0f,1f,0f));
...
//        clip.start();
    ...
    ScriptingRunnable animateNodeRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(msn == null)
                {
                msn = new flapper2SingleNode(renderer, avatar);
                }
    ...
    ScriptingRunnable animateOneNodeRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new flapper2MultipleNodes(renderer, string1, string2);
                }
    ...
    ScriptingRunnable animate3NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new flapper2MultipleNodes(renderer, string1, string2, string3);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate4NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new flapper2MultipleNodes(renderer, string1, string2, string3, string4);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate5NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new flapper2MultipleNodes(renderer, string1, string2, string3, string4, string5);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animateAllNodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(man == null)
                {
                man = new flapper2AllNodes(renderer);
                }
            ...
            System.out.println("ScriptingActionClass - enter animateAllNodes - startRot = " + animationStartRotation[0] + ":" + animationStartRotation[1] + ":" + animationStartRotation[2]);
