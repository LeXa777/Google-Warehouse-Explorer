...
public class RoundEllie4Cell extends Cell
    {
//    private Set<Animation> animations = new HashSet<Animation>();
    ...
    private RoundEllie4SingleNode msn = null;
    private RoundEllie4ThreeNodes m3n = null;
    private RoundEllie4MultipleNodes mmn = null;
    private RoundEllie4AllNodes man = null;
    
    public RoundEllie4Cell(CellID cellID, CellCache cellCache)
        {
    ...
    public void setClientState(CellClientState state)
        ...
        this.modelURI = ((RoundEllie4CellClientState)state).getModelURI();
        }
    ...
    protected CellRenderer createCellRenderer(RendererType rendererType)
        ...
        if (rendererType == RendererType.RENDERER_JME)
            {
            this.renderer = new RoundEllie4Renderer(this);
    ...
    protected void setStatus(CellStatus status, boolean increasing)
        ...
        System.out.println("RoundEllie4 - status = " + status + " - increasing = " + increasing);
        ...
        if (increasing && status == CellStatus.ACTIVE)
            ...
            sac.insertCmdMap("setLighting", setLightingRun);
            sac.insertCmdMap("setCollision", setCollisionRun);
...
// Build the final key frame Quats from the extracted angles and the Vectors from the extracted translates
    ...
    public void testAnimate(String theName)
        ...
        RoundEllie4RotationAnimation theRotProc = new RoundEllie4RotationAnimation(renderer.getTheEntity(), theSpatial, 0f, 360, new Vector3f(0f,1f,0f));
//        Clip clip = Clip.create(3000, Clip.INDEFINITE, theRotProc);
//        clip.setRepeatBehavior(RepeatBehavior.LOOP);
//        clip.start();
        }

    private void setLighting(boolean flag)
        {
        renderer.setLightingEnabled(flag);
        }
    
    ScriptingRunnable setLightingRun = new ScriptingRunnable()
        {
        @Override
        public void run()
            {
            setLighting(booleanFlag);
            }
        };

    private void setCollision(boolean flag)
        {
        renderer.setCollisionEnabled(flag);
        }

    ScriptingRunnable setCollisionRun = new ScriptingRunnable()
        {
        @Override
        public void run()
            {
            setCollision(booleanFlag);
            }
        };
    ...
    ScriptingRunnable animateNodeRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(msn == null)
                {
                msn = new RoundEllie4SingleNode(renderer, avatar);
                }
    ...
    ScriptingRunnable animateOneNodeRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new RoundEllie4MultipleNodes(renderer, string1, string2);
                }
    ...
    ScriptingRunnable animate3NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new RoundEllie4MultipleNodes(renderer, string1, string2, string3);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate4NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new RoundEllie4MultipleNodes(renderer, string1, string2, string3, string4);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate5NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new RoundEllie4MultipleNodes(renderer, string1, string2, string3, string4, string5);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate6NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new RoundEllie4MultipleNodes(renderer, string1, string2, string3, string4, string5, string6);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate7NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new RoundEllie4MultipleNodes(renderer, string1, string2, string3, string4, string5, string6, string7);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animateAllNodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(man == null)
                {
                man = new RoundEllie4AllNodes(renderer, renderer.getVect());
                }
