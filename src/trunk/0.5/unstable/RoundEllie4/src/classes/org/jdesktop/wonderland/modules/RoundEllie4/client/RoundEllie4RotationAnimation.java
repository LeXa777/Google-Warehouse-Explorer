 ...
 */
public class RoundEllie4RotationAnimation extends AnimationProcessorComponent {
    /**
     ...
     * The constructor
     */
    public RoundEllie4RotationAnimation(Entity entity, Spatial target, float startDegrees, float endDegrees) {
        this(entity, target, startDegrees, endDegrees, new Vector3f(0f,1f,0f));
    }
    public RoundEllie4RotationAnimation(Entity entity, Spatial target, float startDegrees, float endDegrees, Vector3f axis) {
        super(entity);
