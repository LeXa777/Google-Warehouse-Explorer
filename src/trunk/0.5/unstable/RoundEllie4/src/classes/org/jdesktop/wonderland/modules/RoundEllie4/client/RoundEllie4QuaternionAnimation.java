 ...
 * @author morris
 */
public class RoundEllie4QuaternionAnimation extends AnimationProcessorComponent {
    /**
     ...
     * The constructor
     */
    public RoundEllie4QuaternionAnimation(Entity entity, Spatial target, Quaternion startQuat, Quaternion endQuat, Vector3f startTranslation, Vector3f endTranslation)
        {
        super(entity);
