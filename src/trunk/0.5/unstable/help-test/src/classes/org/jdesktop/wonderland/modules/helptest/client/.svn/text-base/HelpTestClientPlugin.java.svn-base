 ...
 * this code.
 */
package org.jdesktop.wonderland.modules.helptest.client;
 ...
 */
@Plugin
public class HelpTestClientPlugin extends BaseClientPlugin {

    // The error logger
    private static final Logger LOGGER =
            Logger.getLogger(HelpTestClientPlugin.class.getName());

    // The I18N resource bundle
    private static final ResourceBundle BUNDLE = ResourceBundle.getBundle(
            "org/jdesktop/wonderland/modules/helptest/client/resources/Bundle");
    ...
    private static final String HELP_ITEMS[][] = {
        {"Sun_Microsystems", "http://www.sun.com"},
    };
    ...
    protected void activate() {
        // Adds all of the menu items in the list.
        for (JMenuItem menuItem : menuItemList) {
            JmeClientMain.getFrame().addToHelpMenu(menuItem);
        }
    }
