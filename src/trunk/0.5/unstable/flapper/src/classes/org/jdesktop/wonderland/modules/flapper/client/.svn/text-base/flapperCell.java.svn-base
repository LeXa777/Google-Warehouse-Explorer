...
public class flapperCell extends Cell
    {
//    private Set<Animation> animations = new HashSet<Animation>();
    ...
    private flapperSingleNode msn = null;
    private flapperThreeNodes m3n = null;
    private flapperMultipleNodes mmn = null;
    private flapperAllNodes man = null;
    
    public flapperCell(CellID cellID, CellCache cellCache)
        {
    ...
    public void setClientState(CellClientState state)
        ...
        this.modelURI = ((flapperCellClientState)state).getModelURI();
        }
    ...
    protected CellRenderer createCellRenderer(RendererType rendererType)
        ...
        if (rendererType == RendererType.RENDERER_JME)
            {
            this.renderer = new flapperRenderer(this);
    ...
    protected void setStatus(CellStatus status, boolean increasing)
        ...
        System.out.println("flapper - status = " + status + " - increasing = " + increasing);
...
// Build the final key frame Quats from the extracted angles and the Vectors from the extracted translates
    ...
    public void testAnimate(String theName)
        ...
        flapperRotationAnimation theRotProc = new flapperRotationAnimation(renderer.getTheEntity(), theSpatial, 0f, 360, new Vector3f(0f,1f,0f));
...
//        clip.start();
    ...
    ScriptingRunnable animateNodeRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(msn == null)
                {
                msn = new flapperSingleNode(renderer, avatar);
                }
    ...
    ScriptingRunnable animateOneNodeRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new flapperMultipleNodes(renderer, string1, string2);
                }
    ...
    ScriptingRunnable animate3NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new flapperMultipleNodes(renderer, string1, string2, string3);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate4NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new flapperMultipleNodes(renderer, string1, string2, string3, string4);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animate5NodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(mmn == null)
                {
                mmn = new flapperMultipleNodes(renderer, string1, string2, string3, string4, string5);
                }
            mmn.setAnimationStartTranslate(animationStartTranslate);
            mmn.setAnimationStartRotation(animationStartRotation);
            mmn.setAnimationTimeMultiplier(animationTimeMultiplier);
    ...
    ScriptingRunnable animateAllNodesRun = new ScriptingRunnable()
        ...
        public void run()
            ...
            if(man == null)
                {
                man = new flapperAllNodes(renderer);
                }
