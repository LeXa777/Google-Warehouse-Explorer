 ...
 * @author morris
 */
public class flapperRenderer extends BasicRenderer
    {
    private Node root = null;
    private flapperCell motherCell = null;
    private Entity mye = null;

    public flapperRenderer(Cell cell)
        {
        super(cell);
        motherCell = (flapperCell)cell;
        }
