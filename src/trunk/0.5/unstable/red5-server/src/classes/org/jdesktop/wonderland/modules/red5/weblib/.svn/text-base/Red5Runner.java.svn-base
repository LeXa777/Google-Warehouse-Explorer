...
/**
 * Runner for starting RED5.
 * @author Jonathan Kaplan <jonathankap@gmail.com>
 */
public class Red5Runner extends BaseRunner {

    /** the default name if none is specified */
    private static final String DEFAULT_NAME = "Red5 Video Server";
    /** the logger */
    private static final Logger LOGGER =
            Logger.getLogger(Red5Runner.class.getName());
