 ...
 */
public class ColladaAvatar implements AvatarSPI {
    ...
    /** Default constructor */
    public ColladaAvatar(String avatarName, String avatarURL) {
    ...
    public AvatarConfigInfo getAvatarConfigInfo(ServerSessionManager session) {
        return new AvatarConfigInfo(avatarURL, ColladaAvatarLoaderFactory.class.getName());
    }
}
