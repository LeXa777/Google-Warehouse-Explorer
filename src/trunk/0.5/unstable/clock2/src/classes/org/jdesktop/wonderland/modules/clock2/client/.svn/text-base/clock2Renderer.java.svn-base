 ...
 * @author morris
 */
public class clock2Renderer extends BasicRenderer
    {
    private Node root = null;
    private clock2Cell motherCell = null;
    private Entity mye = null;

    public clock2Renderer(Cell cell)
        {
        super(cell);
        motherCell = (clock2Cell)cell;
        }
