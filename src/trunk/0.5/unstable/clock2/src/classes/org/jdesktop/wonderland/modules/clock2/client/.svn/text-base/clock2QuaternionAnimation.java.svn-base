 ...
 * @author morris
 */
public class clock2QuaternionAnimation extends AnimationProcessorComponent {
    /**
     ...
     * The constructor
     */
    public clock2QuaternionAnimation(Entity entity, Spatial target, Quaternion startQuat, Quaternion endQuat, Vector3f startTranslation, Vector3f endTranslation)
        {
        super(entity);
