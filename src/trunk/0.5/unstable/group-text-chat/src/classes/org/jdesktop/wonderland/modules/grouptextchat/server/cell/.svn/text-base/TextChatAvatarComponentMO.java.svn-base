 ...
 * this code.
 */
package org.jdesktop.wonderland.modules.grouptextchat.server.cell;
...
public class TextChatAvatarComponentMO extends CellComponentMO {
    ...
    protected String getClientClass() {
        return "org.jdesktop.wonderland.modules.grouptextchat.client.cell.TextChatAvatarComponent";
    }
}
