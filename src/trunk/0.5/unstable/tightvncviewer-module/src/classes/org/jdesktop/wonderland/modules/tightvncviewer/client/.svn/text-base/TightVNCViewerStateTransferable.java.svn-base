...
/**
 * A data transfer type for transferring the address of a VNC server
 * in a drag and drop operation.
 *
 * @author nsimpson
 */
public class TightVNCViewerStateTransferable implements Transferable {

    private static final Logger logger = Logger.getLogger(TightVNCViewerStateTransferable.class.getName());
    private Set<DataFlavor> flavors = new HashSet();
    private Image snapshot;

    public TightVNCViewerStateTransferable(Image snapshot) {
