...
public abstract class CellMenu {
    ...
    protected void initializeMenu() {
        ...
        closeMenuButton = hud.addHUDImageButton(cancelURL, "Close Menu", origin.x + 432 - 21, origin.y + 5, 0, false);
    ...
    protected void addCellMenuListener(PDFCellMenuListener listener) {
        synchronized (cellMenuListeners) {
            cellMenuListeners.add(listener);
        }
    }

    protected void removeCellMenuListener(PDFCellMenuListener listener) {
        synchronized (cellMenuListeners) {
